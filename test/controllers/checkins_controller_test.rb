...
class CheckinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create checkin" do
    assert_difference("Checkin.count") do
      post checkins_url, params: { checkin: { date: @checkin.date, mood: @checkin.mood, sleep: @checkin.sleep, user_id: @checkin.user_id } }
    end
  ...
  test "should update checkin" do
    patch checkin_url(@checkin), params: { checkin: { date: @checkin.date, mood: @checkin.mood, sleep: @checkin.sleep, user_id: @checkin.user_id } }
